...
namespace MRP.BL
{
    public class BaseADOPG
    {
        ...
        protected static NpgsqlConnection _connObj = null;
        protected static NpgsqlConnection _connObjEx = null;
        ...
        protected static bool OpenConnection()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                try
                {
                    _connObj = new NpgsqlConnection(_connString);
                    _connObj.Open();
                    _connected = true;
                }
                catch (Exception ex)
        ...
        protected static bool OpenConnectionEx()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                try
                {
                    _connObjEx = new NpgsqlConnection(_connString);
                    _connObjEx.Open();
                    _connected = true;
                }
                catch (Exception ex)
        ...
        protected static bool OpenConnectionTrx(ref NpgsqlConnection trxconn)
        {
            bool _connected = false;
            ...
            for (int i = 0; i < 5; i++)
            {
                try
                {
                    trxconn = new NpgsqlConnection(_connString);
                    trxconn.Open();
                    _connected = true;
                }
                catch (Exception ex)
        ...
        protected static void CloseConnectionTrx(ref NpgsqlConnection trxconn)
        {
            //MOK 5-Nov-2012
            // Enhance the close connection method.
            try
        ...
        protected static DataTable GetData(NpgsqlCommand cmd)
        {
            ...
            try
            {
                if (OpenConnectionTrx(ref trxconn))
                {
                    ...
                    using (NpgsqlDataAdapter _da = new NpgsqlDataAdapter(cmd))
                    {
                        _da.Fill(_dt);
                    }
                }
        ...
        public static DataTable GetData(string sqlStr)
        {
            ...
            try
            {
                if (OpenConnectionTrx(ref trxconn))
                {
                    NpgsqlCommand cmd = new NpgsqlCommand(sqlStr, trxconn);
        ...
        public static DataTable GetData(string sqlStr,ref NpgsqlDataAdapter da, ref NpgsqlConnection trxconn)
        {
            DataTable _dt = new DataTable();
        ...
        public static void ExceuteSqlEx(string sqlStr, NpgsqlConnection trxconn)
        {
            DataTable _dt = new DataTable();
            try
            {
        ...
        public static void ExceuteSql(string sqlStr, NpgsqlConnection trxconn,NpgsqlTransaction trans)
        {
            DataTable _dt = new DataTable();
            try
            {
                    NpgsqlCommand cmd = new NpgsqlCommand(sqlStr, trxconn,trans);
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandTimeout = 60;
                    cmd.ExecuteNonQuery();
            }
        ...
        public static bool UpdateTable(ref DataTable tablename, ref NpgsqlDataAdapter da)
        {
            bool success = false;
            NpgsqlConnection trxconn = null;
